    ...
    <div className=' bg-[#FDE8E8] select-none dark:bg-gray-800'>
      <div className="md:flex gap-5 justify-between w-[80%]  mx-auto py-10 md:py-0">
        <div className="space-y-5  mb-8 md:mt-[100px]  ">
          ...
          <p className='text-sm lg:text-[22px] font-lato text-gray-500 leading-9 dark:text-white'>End the struggle of finding a bride or groom. Discover your <br className="hidden md:flex" /> perfect match from the comfort of home. Your ultimate <br className="hidden md:flex" /> destination to find your ideal partner</p>

          <div className="lg:flex items-center gap-8 ">
            <Link to='/allUser' className='bg-primary-500 rounded-full text-white px-16 py-2 mt-4 md:text-[22px]'>Explore </Link>
            <button onClick={openVideoModal} className='flex justify-center items-center gap-2 mt-4 text-[22px]'>
              ...
              <span className="text-base md:text-[22px] dark:text-white">How it works</span>
            </button>
          </div>
        </div>
