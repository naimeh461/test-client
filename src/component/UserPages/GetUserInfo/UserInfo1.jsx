        ...
        <form className="p-10" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex gap-5 mt-3">
                      <label className="cursor-pointer">
                        <input
                          ...
                          name="gender"
                          onChange={() =>
                            setSelectedOption({ gender: gender?.name })
                          }
                        />
                    ...
                    <div className="flex gap-5 mt-3">
                      <label className="cursor-pointer">
                        <input
                          ...
                          name="marriage"
                          onChange={() =>
                            setMaritalStatus({ maritalStatus: marriage?.name })
                          }
                        />
                        <div className=" max-w-xl rounded-3xl bg-gray-100 p-2 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-[#51ac83]  peer-checked:ring-[#51ac83] peer-checked:ring-offset-2">
                          <div className="flex flex-col ">
                    ...
                    <div className="flex gap-5 mt-3">
                      <label className="cursor-pointer">
                        <input
                          ...
                          name="religion"
                          onChange={() =>
                            setReligion({ Religion: religion?.name })
                          }
                        />
                        <div className=" max-w-xl rounded-3xl bg-gray-100 p-2 text-gray-600 ring-2 ring-transparent transition-all hover:shadow peer-checked:text-[#51ac83]  peer-checked:ring-[#51ac83] peer-checked:ring-offset-2">
                          <div className="flex flex-col ">
                    ...
                    <div className="relative mt-1 w-full">
                      <Listbox.Button className="relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                        <span className="block truncate">
                          {motherTongue ? motherTongue.name : "Default"}
                        </span>
          ...
          <div className="flex justify-center mt-10">
            <button
              ...
              type="submit"
              className="btn px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-[#fa604c] rounded-md hover:bg-[#943f34] focus:outline-none focus:bg-gray-600"
            >
              Continue
